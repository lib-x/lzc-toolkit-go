...
project_forbidden='(google\.golang\.org/grpc|golang\.org/x/crypto/ssh|github\.com/docker|github\.com/lib-x/lpk-go/(appstore|remote/(ssh|shellapi)|project/rsync|image/(dockerlocal|buildpack)))'
...
project_workflow_forbidden='(google\.golang\.org/grpc|golang\.org/x/crypto/ssh|github\.com/docker|github\.com/lib-x/lpk-go/(appstore|remote/(ssh|shellapi)|image/(dockerlocal|buildpack)))'
